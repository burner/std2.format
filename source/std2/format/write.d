...
Source: $(PHOBOSSRC std2.format/write.d)
 */
module std2.format.write;
...
$(MREF_ALTTEXT compound specifiers, std2.format) characters are
treated differently.
 */
@safe pure unittest
{
...
compound specifiers, std2.format) strings are treated differently.
 */
@safe pure unittest
{
    import std.array : appender;
...
{
    import std2.format : checkFormatException;
