...
/*
   ...
   Source: $(PHOBOSSRC std2.format/internal/read.d)
 */
module std2.format.internal.read;
...
if (isInputRange!Range && is(immutable T == immutable bool))
{
    ...
    import std2.format : enforceFmt, unformatValue;
...
{
    import std.range.primitives : empty, front, popFront;
    import std2.format : enforceFmt, format;
...
if (isInputRange!Range)
{
    ...
    import std2.format.read : unformatValue;
