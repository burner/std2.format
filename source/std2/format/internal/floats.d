...
package(std2.format) void printFloat(Writer, T, Char)(auto ref Writer w, const(T) val, FormatSpec!Char f)
if (is(T == float) || is(T == double)
    || (is(T == real) && (T.mant_dig == double.mant_dig || T.mant_dig == 64)))
{
    ...
    if (exp == T.max_exp)
    {
        import std2.format.internal.write : writeAligned;
    ...
    || (is(T == real) && (T.mant_dig == double.mant_dig || T.mant_dig == 64)))
{
    ...
    import std2.format.internal.write : writeAligned, PrecisionType;
    ...
    {
        import std2.format.internal.write : RoundingClass, round;
...
if (is(T == float) || is(T == double)
    || (is(T == real) && (T.mant_dig == double.mant_dig || T.mant_dig == 64)))
{
    import std2.format.internal.write : writeAligned, PrecisionType, RoundingClass, round;
    ...
    || (is(T == real) && (T.mant_dig == double.mant_dig || T.mant_dig == 64)))
{
    ...
    import std2.format.internal.write : RoundingMode;
